...
class News {
    ...
    public function addNews($title, $content, $image,$created_at, $category_id) {
        $sql = "INSERT INTO tintuc (title, content, image, created_at, category_id) 
    ...
    public function updateNews($id, $title, $content, $image,$created_at, $category_id) {
        $sql = "UPDATE tintuc SET title = :title, content = :content, image = :image, created_at = :created_at, category_id = :category_id
                WHERE id = :id";
